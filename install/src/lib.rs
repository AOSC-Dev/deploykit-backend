...
fn run_dracut(cancel_install: &AtomicBool, progress: &AtomicU8) -> Result<bool, RunCmdError> {
    info!("Running dracut ...");
    cancel_install_exit!(cancel_install);
